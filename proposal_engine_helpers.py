"""Support mixin for proposal-engine interaction, prompt, and validation helpers."""
...
from llm_backend import extract_text_channels, resolve_prompt_variant
from proposal_gates import (
...
from proposal_parsing import ProposalExtractionError
...
class ProposalEngineSupportMixin:
