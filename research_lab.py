...
LAB_STATE = {'accepted_experiments': [{'composite_score': 0.9043986057974769,
                          ...
                          {'composite_score': 0.882910773048627,
                           ...
                           'model_name': 'RandomForestRegressor',
                           'proposal_family': 'RandomForestRegressor-exploit'},
                          {'composite_score': 0.8832438187584769,
                           'confirm_improvement_pct': 0.02393772871721014,
                           'experiment_id': 'confirm-scout-015-randomforestregressor-exploit-max_features-alt',
                           'model_name': 'RandomForestRegressor',
                           'proposal_family': 'RandomForestRegressor-exploit'},
                          {'composite_score': 0.8832449443563595,
                           'confirm_improvement_pct': 0.00012743908971247407,
                           'experiment_id': 'confirm-scout-011-randomforestregressor-exploit-n_estimators-up',
                           'model_name': 'RandomForestRegressor',
                           'proposal_family': 'RandomForestRegressor-exploit'}],
