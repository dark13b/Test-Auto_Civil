...
def build_stacking_ensemble(
    ...
    stacking_model = StackingRegressor(
        ...
        passthrough=True,
        cv=build_cv_splitter(config, n_splits=cv_splits, repeats=1, random_state=42),
        n_jobs=-1,
    )

    cv_splitter = build_cv_splitter(config, n_splits=cv_splits, repeats=1, random_state=42)
